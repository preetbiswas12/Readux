...
var AegisChatTestSuite_1 = require("./AegisChatTestSuite");
var testGroup = process.argv[2] || 'all';
...
console.log("  Test Group: ".concat(testGroup.toUpperCase()));
console.log("  Verbose:    ".concat(verbose ? 'YES' : 'NO'));
console.log('');
...
try {
    ...
    console.log('');
    // Execute tests
    AegisChatTestSuite_1.testSuite
        .runAllTests()
        .then(function () {
        process.exit(0);
    })
