...
export const ALL_STUN_SERVERS = [
  ...TIER1_STUN,
  ...TIER2_STUN,
  ...TIER3_STUN,
];

export const ALL_TURN_SERVERS = [
  ...TIER1_TURN,
  ...TIER2_TURN,
];

export const STUN_SERVERS_BY_TIER = {
  primary: TIER1_STUN,
  secondary: TIER2_STUN,
  fallback: TIER3_STUN,
};

export const TURN_SERVERS_BY_TIER = {
  primary: TIER1_TURN,
